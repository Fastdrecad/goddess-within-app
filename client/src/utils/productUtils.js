...
// Add these utility functions to your existing productUtils.js

export const areProductsEqual = (item1, item2) => {
  return item1._id === item2._id && item1.sizes[0].size === item2.sizes[0].size;
};
